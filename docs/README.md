...
Этот каталог содержит подробную документацию по новой версии `Eng_estimate`, построенной вокруг файла `Engineering Efficiency Measurement.xlsx` и текста ТЗ `Текст ТЗ.docx`.
...
- `Engineering Efficiency Measurement.xlsx` - источник расчетной модели.
- `Текст ТЗ.docx` - функциональное задание.
